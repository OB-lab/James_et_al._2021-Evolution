...
# All traits
allTraits <- read.delim ("path-to-file/allTraits.txt", header = T)
...
allTraitsPairs <- read.delim ("path-to-file/allTraitsPairs.txt", header = T)
...
traitMeansPairs <- read.delim ("path-to-file/traitMeansPairs.txt", header = T)
